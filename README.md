...
Wedge Dropout is a regularization technique makes these feature maps less similar. Here is a heatmap showing correlation across all 64 feature maps for a very simple Convolutional Neural Network:

![heatmap](pics/Feature%20Map%20Similarity%20Grid%20-%20Color.png)

At the start of training, the feature maps are strongly correlated (magenta) and quickly become less correlated as training continues. Feature maps naturally become decorrelated during training; Wedge Dropout optimizes this decorrelation.
